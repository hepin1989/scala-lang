...
headerSubtitle: "Scala is a **consistent**, **elegant** and **expressive** language. Scala helps you to build highly **elastic**, **resilient** and **responsive** applications quickly, run them fast on JVM and JavaScript runtimes, with huge ecosystems, expressive language features and great inter-operation."
